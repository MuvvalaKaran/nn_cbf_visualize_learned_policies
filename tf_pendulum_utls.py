...
def plot_pendulum_w_cbf_evolution(system_state: np.array,
    ...
    hypercube_idx_dict = create_hypercube_idx_dict(partitions)
...
def simulate_toy_2d_system(system_state: np.array,
    ...
    if num_controllers == 2:
        ...
        # DEBUGGIN -04/16 625 hypercunes with new controller
        # 110 : [[-1.7 -1.5], [-0.7, -0.5]]
...
if __name__ == "__main__":
    ...
    system_state = np.array([-1.6, -0.6])  # 2d array - 04/16 debugging
